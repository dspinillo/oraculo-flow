...
1. Leia o `CLAUDE.md` do projeto e o `LESSONS.md` antes de tocar em código — especialmente "Armadilhas conhecidas" e os erros já registrados. Repetir um erro que está no LESSONS é falha evitável.
