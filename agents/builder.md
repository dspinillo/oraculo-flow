...
1. Leia o `CLAUDE.md`, o `LESSONS.md` e o `CONTEXT.md` do projeto antes de tocar em código — armadilhas e erros já registrados, e o vocabulário do domínio (nomeie do jeito do CONTEXT, não invente sinônimo). Repetir um erro do LESSONS é falha evitável.
